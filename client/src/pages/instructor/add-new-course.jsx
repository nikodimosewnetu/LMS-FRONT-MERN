...
function AddNewCoursePage() {
  ...
  function validateFormData() {
    let isValid = true;
    // Check if courseLandingFormData has empty fields
    ...
    // Check if curriculumFormData has empty fields
  ...
  useEffect(() => {
    console.log('Form validation result:', validateFormData());
